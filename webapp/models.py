...
#Opciones para perfil Planificación Anual Académica
tiposPerfilPAA = [
    ('Académico', 'Académico'),
    ('Jefe Departamento', 'Jefe Departamento'),
    ('Jefe Carrera', 'Jefe Carrera'),
    ('Dirección/Desarrollo Académica', 'Dirección/Desarrollo Académica'),
]
...
class ReporteAccion (models.Model) :
    ...
    recomendacion = models.TextField(verbose_name='Recomendación a la Accion', null=True, blank=True)
...
class PerfilUsuario(models.Model) :
    ...
    perfil_planificacion = models.CharField(max_length=MAX_LENGTH, verbose_name='Perfil Planificación Anual Académica', null=True, choices=tiposPerfilPAA)
