...
# endpoints planificación académica
router.register(r'planificacionesAcademicas', views.PAA_PlanificacionViewSet)
# router.register(r'rolesPlanificacionAcademica', views.PAA_RolViewSet)
router.register(r'observacionesPlanificacionAcademica', views.PAA_ObservacionPlanificacionViewSet)
router.register(r'asignaturasPlanificacionAcademica', views.PAA_AsignaturaViewSet)
# endpoints planificación académica
...
urlpatterns = [
    ...
    # endpoints planificación académica
    path('obtener_cursos/', views.obtener_cursos, name='obtener_cursos'),
    path('mis_cursos/',views.mis_cursos, name='mis_cursos'),
    path('usuarios_departamento/',   views.usuarios_departamento, name='usuarios_departamento'),
    path('planificacionVinculacionCompromisos/',   utils.planificacionVinculacionCompromisos, name='planificacionVinculacionCompromisos'),    
    ################################### Flujo cambios de estado Planificación ################################
    path('planificacionEnvioAJefeDpto/',    utils.planificacionEnvioAJefeDpto, name='planificacionEnvioAJefeDpto'),
    path('planificacionJefeDptoRechaza/',   utils.planificacionJefeDptoRechaza, name='planificacionJefeDptoRechaza'),
    path('planificacionJefeDptoAcepta/',    utils.planificacionJefeDptoAcepta, name='planificacionJefeDptoAcepta'),
    path('planificacionDireccionRechaza/',  utils.planificacionDireccionRechaza, name='planificacionDireccionRechaza'),
    path('planificacionDireccionAcepta/',   utils.planificacionDireccionAcepta, name='planificacionDireccionAcepta'),    
    ################################### Flujo cambios de estado Planificación ################################
    # endpoints planificación académica

    path('generarPdf/<int:id_reporte>', views.ReporteUpciPDFViewSet.as_view(), name='generarReporteUpci'),
    path('generarPdfUnificado/', views.ReporteUpciPDFUnificadoViewSet.as_view(), name='generarReporteUpciUnificado'),
    path('generarPdfUnificadoUnidad/<int:id_reporte>', views.ReporteUpciPDFUnificadoUnidadViewSet.as_view(), name='generarReporteUpciUnificadoUnidad'),
