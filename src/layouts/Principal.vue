...
export default {
  ...
  setup() {
    ...
    const linksList = ref([
      ...
      {
        title: "Navegador POA",
        caption: "Acciones del Plan Operativo Anual de la Universidad",
        icon: "sailing",
        link: "navegadorPOA",
      },
      {
    ...
    //Se incluye manejo de perfiles cuyo actor asociado tenga categoria "académicas"
    
    if (usuario.value.perfil.esAreaAcademico) {
      let link = "";
      switch (usuario.value.perfil.planificacionAcademica) {
        case "Académico":
          link = "panelAcademico";
          break;
        case "Jefe Departamento":
          link = "panelJefeDepartamento";
          break;
        case "Jefe Carrera":
          link = "panelJefeCarrera";
          break;
        case "DIrección/Desarrollo Académica":
          link = "panelDireccionAcademica";
          break;
        default:
          console.log("Error: Valor no reconocido para planificacionAcademica");
          break;
      }

      if (link !== "") {
        linksList.value.splice(1, 0, {
          title: "Panel Planificación Académica",
          caption: "Estado de asignaturas y Planificaciones Anuales Académicas",
          icon: "menu_book",
          link: link,
        });
      }
