<template>
    ...
    > 
        ...
        <q-card style="width: 1000px; max-width: 80vw;">
            <q-card-section>
                <div class="text-h6 text-textoAzul">Ingresar nuevo Programa a la Planificación Académica</div>                
            </q-card-section>
            ...
            <q-card-section>
                ...
                <q-form @submit="handleClick('guardar')" class="text-textoAzul">
                    ...
                    <q-item>
                        <q-item-section>
                            <q-item-label><b>Programa:</b></q-item-label>
                        </q-item-section>
                        <q-item-section>        
                            <q-input
                    ...
                    <q-item>
                        <q-item-section>
                            <q-item-label><b>Programacion u otro:</b></q-item-label>
                        </q-item-section>
                        <q-item-section>        
                            <q-input
                    ...
                    <q-item>
                        <q-item-section>
                            <q-item-label><b>Observaciones:</b></q-item-label>
                        </q-item-section>
                        <q-item-section>        
                            <q-input
