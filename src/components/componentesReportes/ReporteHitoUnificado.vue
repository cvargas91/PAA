        ...
        setup(props) {   
            ...
            const cambioAtras = async () => {
                ...
                if(nuevoReporte.value.nuevoReporteHitos.length){
                    ...
                    indicadorLogro.value.value = nuevoReporte.value.nuevoReporteHitos[pasoHito.value].indicador_logro;
            ...
            if(nuevoReporte.value.nuevoReporteHitos.length){
                ...
                indicadorLogro.value.value = nuevoReporte.value.nuevoReporteHitos[0].indicador_logro;
            };
