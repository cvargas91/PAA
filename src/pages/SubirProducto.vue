    ...
    <div v-else-if="entrega.nuevaEntrega">
      ...
      >
        ...
        > 
          ...
          <div v-if="entrega.nuevaEntrega.anio == 2022 && accion.MDVs.length == 0">            
            <q-banner class="bg-primary text-white">
          ...
          <div v-if="entrega.nuevaEntrega.anio != 2022 && !accion.MDVs.length">            
            {{ validaMDV(hitosSeleccionados) }}
            <q-field label="Medio de Verificación" stack-label v-if="!accion.MDVs.length">
              <template v-slot:control>
                <div class="self-center full-width no-outline" tabindex="0">{{mdvSeleccionado.descripcion}}</div>
              </template>
            </q-field>
